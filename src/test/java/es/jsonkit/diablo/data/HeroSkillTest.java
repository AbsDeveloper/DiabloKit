...
public class HeroSkillTest {
	...
	public void test() {
		...
		try {
			...
			HeroSkillTest.LOGGER.error("La informacion no pudo ser recogida, servicio no disponible " + uhe.getMessage());
			Assert.fail();
		}
		catch (MalformedURLException mue) {
			HeroSkillTest.LOGGER.error("La informacion no pudo ser recogida, se ha especificado un protocolo desconocido " + mue.getMessage());
			Assert.fail();
		}
