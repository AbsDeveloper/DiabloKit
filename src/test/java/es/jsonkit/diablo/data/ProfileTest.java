...
public class ProfileTest {
	...
	public void test() {
		...
		try {
			...
			ProfileTest.LOGGER.error("La informacion no pudo ser recogida, servicio no disponible " + uhe.getMessage());
			Assert.fail();
		}
		catch (MalformedURLException mue) {
			ProfileTest.LOGGER.error("La informacion no pudo ser recogida, se ha especificado un protocolo desconocido " + mue.getMessage());
			Assert.fail();
		}
